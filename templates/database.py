...
class Database:
    ...
    def get_listings_by_item(self, item_search, limit=None):
        # Fetch all matching items based on the search term, and apply limit if provided
        query = "SELECT * FROM listings WHERE item LIKE ? ORDER BY id DESC"
        params = [f'%{item_search}%']
