...
def get_manual_cookies():
    return {
        'session': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdGVhbV9pZCI6Ijc2NTYxMTk5MTY5NTk2NjY0Iiwibm9uY2UiOjAsImltcGVyc29uYXRlZCI6ZmFsc2UsImlzcyI6ImNzdGVjaCIsImV4cCI6MTcyNzA0MDU4NX0.QlnVodXKjItToFC1BRWdSVbJiJ6QR88jKU-y2j99J-o',}
